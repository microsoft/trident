...
gantt
    ...
    installation_id #1 (since install #1) :active, inst1, 2024-01-01, 9d
    installation_id #2 (since install #2) :active, inst2, 2024-01-10, 2d
    ...
    install         :active, o1, 2024-01-01, 1d
    commit          :active, o2, 2024-01-02, 1d
    update          :active, o3, 2024-01-03, 1d
    commit          :active, o4, 2024-01-04, 1d
    update-stage    :active, o5, 2024-01-05, 1d
    update-finalize :active, o6, 2024-01-06, 1d
    commit          :active, o7, 2024-01-07, 1d
    rollback        :active, o8, 2024-01-08, 1d
    commit          :active, o9, 2024-01-09, 1d
    install         :active, o10, 2024-01-10, 1d
    commit          :active, o11, 2024-01-11, 1d
```
