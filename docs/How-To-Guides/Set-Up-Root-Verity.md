...
In addition to the typical `root` partition definition, a `root-hash` partition
is needed like this:
...
Putting that all together and following the Image Customizer
