...
### Submitting an Proposal Discussion
...
RFC. To start and RFC, clone the Trident repository and create copy of the RFC
...
Once a PR is created, update the file name prefic from `0000` to the GitHub PR
issue number with the apropriate padding. For example, if the PR number is `42`,
