...
// Generate the Go structs for the Harpoon protobuf located at ../../../proto/harpoon.proto
//go:generate protoc -I ../../../proto --go_out=harpoonpbv1 --go_opt=paths=source_relative --go_opt=Mharpoon.proto=tridenttools/pkg/harpoon/harpoonpbv1 --go-grpc_out=harpoonpbv1 --go-grpc_opt=paths=source_relative --go-grpc_opt=Mharpoon.proto=tridenttools/pkg/harpoon/harpoonpbv1 harpoon.proto
