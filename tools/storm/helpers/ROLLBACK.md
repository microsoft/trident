...
# IMAGE_NAME="trident-testimage"
# IMAGE_NAME="trident-verity-testimage"
IMAGE_NAME="trident-usrverity-testimage"

COSI_NAME="regular"
if [ "$IMAGE_NAME" == "trident-usrverity-testimage" ]; then
    COSI_NAME="usrverity"
fi
if [ "$IMAGE_NAME" == "trident-verity-testimage" ]; then
    COSI_NAME="verity"
fi
