...
pub fn sample_host_configuration(name: &str) -> Result<(String, HostConfiguration), Error> {
    let sample_pair = match name {
        "basic" => (
            "Basic sample with a bootable deployment.".into(),
            HostConfiguration {
                storage: Storage {
                    disks: vec![Disk {
                        id: "os".to_string(),
        ...
        "simple" => (
            "Simple sample showcasing OS config of networking, users, additional files and customer scripts.".into(),
            HostConfiguration {
                storage: Storage {
                    disks: vec![Disk {
                        id: "os".to_string(),
        ...
        "base" => (
            "Base sample config showcasing raid, encryption and A/B update.".into(),
            HostConfiguration {
                storage: Storage {
                    disks: vec![Disk {
                        id: "os".to_string(),
        ...
        "verity" => (
            "Verity sample showcasing usage of dm-verity.".into(),
            HostConfiguration {
                storage: Storage {
                    disks: vec![Disk {
                        id: "os".to_string(),
        ...
        "advanced" => (
            "Advanced sample showcasing combination of RAID, encryption, dm-verity and A/B update.".into(),
            HostConfiguration {
                storage: Storage {
                    disks: vec![
                        Disk {
                            ...
                            adopted_partitions: vec![AdoptedPartition {
                                ...
                                uuid: Some(
                                    Uuid::parse_str("a0a0a0a0-a0a0-a0a0-a0a0-a0a0a0a0a0a0")
                                        .unwrap(),
                                ),
                                ..Default::default()
                            }],
                    ...
                    raid: Raid {
                        software: vec![
                            ...
                            SoftwareRaidArray {
                                ...
                                level: RaidLevel::Raid1,
                                devices: vec![
                                    "root-hash-a1".to_string(),
                                    "root-hash-a2".to_string(),
                                ],
                                metadata_version: "1.0".into(),
                            },
                            SoftwareRaidArray {
                                ...
                                level: RaidLevel::Raid1,
                                devices: vec![
                                    "root-hash-b1".to_string(),
                                    "root-hash-b2".to_string(),
                                ],
                                metadata_version: "1.0".into(),
                            },
                            SoftwareRaidArray {
        ...
        "raid" => (
            "RAID sample showcasing usage of RAID.".into(),
            HostConfiguration {
                storage: Storage {
                    disks: vec![
                        Disk {
        ...
        "encryption" => (
            "Encryption sample showcasing usage of encryption".into(),
            HostConfiguration {
                storage: Storage {
                    disks: vec![
                        Disk {
...
mod tests {
    ...
    fn test_build_advanced_host_configuration() {
        ...
        assert_eq!(host_configuration.storage.mount_points.len(), 10);
        assert_eq!(host_configuration.storage.images.len(), 6);
        assert!(host_configuration.storage.ab_update.is_some());
        assert!(host_configuration.os.network.is_some());
        assert_eq!(host_configuration.os.users.len(), 1);
        assert_eq!(host_configuration.storage.verity.len(), 1);
    ...
    fn test_build_raid_host_configuration() {
        ...
        assert!(host_configuration.storage.encryption.is_none());
        assert_eq!(host_configuration.storage.raid.software.len(), 1);
        assert_eq!(host_configuration.storage.mount_points.len(), 4);
        assert_eq!(host_configuration.storage.images.len(), 3);
        assert!(host_configuration.storage.ab_update.is_none());
        assert!(host_configuration.os.network.is_some());
        assert_eq!(host_configuration.os.users.len(), 1);
        assert_eq!(host_configuration.storage.verity.len(), 0);
