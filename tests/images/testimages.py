...
DEFINED_IMAGES: List[ImageConfig] = [
    ...
    ImageConfig(
        "ubuntu-direct-streaming-testimage-22.04-amd64",
    ...
    ImageConfig(
        "ubuntu-direct-streaming-testimage-22.04-arm64",
        config="ubuntu-direct-streaming-testimage",
        config_file="base/baseimg-2204.yaml",
    ...
    ImageConfig(
        "ubuntu-direct-streaming-testimage-24.04-amd64",
        config="ubuntu-direct-streaming-testimage",
    ...
    ImageConfig(
        "ubuntu-direct-streaming-testimage-24.04-arm64",
        config="ubuntu-direct-streaming-testimage",
        config_file="base/baseimg-2404.yaml",
        base_image=BaseImage.UBUNTU_ARM64,
        output_format=OutputFormat.BAREMETAL_IMAGE,
    ...
    ImageConfig(
        "fairwater-direct-streaming-testimage-22.04-arm64",
        config="ubuntu-direct-streaming-testimage",
        config_file="base/baseimg-2204.yaml",
        base_image=BaseImage.FAIRWATER_ARM64,
        output_format=OutputFormat.BAREMETAL_IMAGE,
        architecture=SystemArchitecture.ARM64,
        rpm_sources_allowed=False,
    ),
