...
generated by MIC). It is based on the baremetal image and adds Trident as well
as its dependencies. It also adds openssh-server to allow for remote access.
Finally, it contains duplicate set of partitions to setup the disk layout for
A/B update.
