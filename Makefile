...
bin/trident-mos.iso: artifacts/baremetal.vhdx artifacts/imagecustomizer systemd/trident.service trident-mos/iso.yaml trident-mos/files/* trident-mos/post-install.sh
	@mkdir -p bin
	BUILD_DIR=`mktemp -d` && \
